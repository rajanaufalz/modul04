...
const App = () => {
  ...
  const pageArr = [
    ...
    { name: "Fixed Dimension Basics", comp: <FixedDimensionBasics /> },
    { name: "Flex Dimension Basics", comp: <FlexDimensionBasics /> },
    {
      name: "Percentage Dimensions Basics",
      comp: <PercentageDimensionBasics />,
    },
