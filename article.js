...
const Article = () => {
    ...
    return (
        <ScrollView>
            <Image alt="article"
                source={{ uri: "https://ce.ittelkom-sby.ac.id/wp-content/uploads/2020/09/WhatsApp-Image-2018-04-18-at-11.47.40-AM-1024x564-1.png", }}
            ...
            <Box p={4}>
                <Image alt="Image"
                    source={{ uri: "https://ittelkom-sby.ac.id/wp-content/uploads/2022/10/asdfghkl-768x472.jpg", }}
